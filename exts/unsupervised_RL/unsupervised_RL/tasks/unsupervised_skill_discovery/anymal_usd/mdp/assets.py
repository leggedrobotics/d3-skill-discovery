...
ROBOT_USD_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/home/rafael/Projects/MT/unsupervised_RL/exts/unsupervised_RL/unsupervised_RL/tasks/unsupervised_skill_discovery/anymal_usd/mdp/urdfs/output_2.usd",
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
