...
class CommandsCfg:
    ...
    base_velocity = mdp.UniformVelocityCommandCfg(
        asset_name="robot",
        resampling_time_range=(10000.0, 100000.0),  # never
...
class VelocityTrackingEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self):
        ...
        if self.scene.height_scanner_oracle is not None:
            self.scene.height_scanner_oracle.update_period = self.decimation * self.sim.dt
