...
# Pre-defined configs
##
from unsupervised_RL.tasks.downstream.pedipulation.box_manipulation_base_env_cfg import BaseSceneCfg, BoxPoseEnvCfg
...
class ActionsCfg:
    ...
    skill_action = mdp.SkillSelectionActionCfg(
        ...
        skill_policy_file_path="/home/rafael/Projects/MT/CRL/unsupervised_RL/logs/rsl_rl/metra_factors_ppo_anymal_test/box_metra_3/exported/policy.pt",
        skill_space={
