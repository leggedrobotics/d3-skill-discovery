...
import unsupervised_RL.tasks.downstream.pedipulation.mdp as mdp
import unsupervised_RL.tasks.unsupervised_skill_discovery.anymal_usd.mdp as usd_mdp
from unsupervised_RL.tasks.unsupervised_skill_discovery.anymal_usd.mdp.assets import (
    CUBOID_BIG_CFG,
    CUBOID_FLAT_CFG,
    CUBOID_SMALL_CFG,
    CUBOID_TALL_CFG,
...
class CommandsCfg:
    ...
    box_goal_pose = mdp.UniformPose2dCommandCfg(
        asset_name="box",
        resampling_time_range=(10000.0, 10000.0),  # never
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        box_pose_commands = ObsTerm(func=mdp.generated_commands, params={"command_name": "box_goal_pose"})
...
class EventCfg:
    ...
    reset_box = EventTerm(
        func=usd_mdp.reset_save_root_state_uniform,
        mode="reset",
        params={
            "pose_range": {"y": (-1.0, 1.0), "z": (0.01, 0.05), "yaw": (-math.pi, math.pi)},
            # "pose_range": {"z": (0.01, 0.05)},
            "velocity_range": {},
            "asset_cfg": SceneEntityCfg("box"),
        },
    )
...
class RewardsCfg:
    ...
    moving_towards_goal = RewTerm(
        ...
        weight=10.0,
        params={"command_name": "box_goal_pose"},
    )
    rotating_towards_goal_if_at_goal = RewTerm(
        func=mdp.correct_heading_if_close,
        weight=10.0,
        params={"command_name": "box_goal_pose", "dist_threshold": 1.0},
    )
...
class TerminationsCfg:
    ...
    goal_reached = DoneTerm(
        ...
        params={"goal_cmd_name": "box_goal_pose", "distance_threshold": 0.25, "angle_threshold": math.radians(10)},
    )
...
@configclass
class BoxPoseEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the box manipulation environment."""

    # Scene settings
    scene: BaseSceneCfg = BaseSceneCfg(num_envs=4096, env_spacing=5.0)
    # Basic settings
