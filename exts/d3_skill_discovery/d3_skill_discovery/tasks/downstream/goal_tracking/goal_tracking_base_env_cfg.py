...
class MySceneCfg(InteractiveSceneCfg):
    ...
    terrain = TerrainImporterCfg(
        ...
        terrain_generator=usd_mdp.terrain.SLIGHTLY_ROUGH_TERRAINS_CFG,
        max_init_terrain_level=100,
        collision_group=-1,
    ...
    height_scanner_oracle = RayCasterCfg(
        prim_path="{ENV_REGEX_NS}/Robot/base",
        offset=RayCasterCfg.OffsetCfg(pos=(0.0, 0.0, 20.0)),
        attach_yaw_only=True,
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        pose_commands = ObsTerm(func=mdp.generated_commands, params={"command_name": "goal_pose"})
...
class RewardsCfg:
    ...
    rotating_towards_goal_if_at_goal = RewTerm(
        ...
        weight=10.0,
        params={"command_name": "goal_pose", "dist_threshold": 1.0},
    )
...
class TerminationsCfg:
    ...
    goal_reached = DoneTerm(
        ...
        params={"goal_cmd_name": "goal_pose", "distance_threshold": 1.0, "angle_threshold": math.radians(90)},
    )
...
class GoalReachingEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the goal tracking environment."""
