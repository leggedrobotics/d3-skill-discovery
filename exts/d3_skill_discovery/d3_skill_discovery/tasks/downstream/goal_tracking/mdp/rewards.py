...
def moving_towards_goal(
    ...
    goal_command: UniformPose2dCommand = env.command_manager._terms[command_name]
...
def correct_heading_if_close(
    ...
    reward = torch.where(close_enough, 1.0 - heading_error / torch.pi, torch.zeros_like(heading_error))
