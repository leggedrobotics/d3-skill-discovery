...
ROBOT_USD_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/home/rafael/Projects/MT/d3_skill_discovery/exts/d3_skill_discovery/d3_skill_discovery/tasks/unsupervised_skill_discovery/anymal_usd/mdp/urdfs/output_2.usd",
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
