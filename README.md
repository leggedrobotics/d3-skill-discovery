...
- ✅ Install the [`d3_rsl_rl`](source/d3_rsl_rl/) package with USD algorithms
- ✅ Register the [`d3_skill_discovery`](source/d3_skill_discovery/d3_skill_discovery/) extension with Isaac Lab
...
<details>
<summary><b>Using Docker for Easy Setup</b></summary>
...
| **NVIDIA Container Toolkit** | [Install NVIDIA Docker](https://docs.nvidia.com/datacenter/cloud-native/container-toolkit/install-guide.html) |
| **GPU Memory** | 16GB+ VRAM recommended |
...
The tasks are implemented inside [`source/d3_skill_discovery/d3_skill_discovery/tasks`](source/d3_skill_discovery/d3_skill_discovery/tasks) directory.
...
|------------|-------------|---------|-------------|
| **🦿 Low-Level USD** | Basic skill learning on rough terrain (as described in paper) | `Isaac-USD-Anymal-D-v0` | [`anymal_usd_env_cfg.py`](source/d3_skill_discovery/d3_skill_discovery/tasks/unsupervised_skill_discovery/anymal_usd/anymal_usd_env_cfg.py) |
| **🎯 High-Level USD** | Hierarchical skill learning (requires pretrained low-level policy) | `Isaac-HL-USD-Anymal-D-v0` | [`anymal_hl_usd_env_cfg.py`](source/d3_skill_discovery/d3_skill_discovery/tasks/unsupervised_skill_discovery/anymal_usd/anymal_hl_usd_env_cfg.py) |
| **📦 USD with Box** | Skill learning with interactive movable box for manipulation | `Isaac-HL-USD-Box-Anymal-D-v0` | [`anymal_hl_usd_box_env_cfg.py`](source/d3_skill_discovery/d3_skill_discovery/tasks/unsupervised_skill_discovery/anymal_usd/anymal_hl_usd_box_env_cfg.py) |
...
|--------------|-------------|-----------|
| **🎯 Goal Tracking** | Goal-reaching navigation on rough terrain | [`goal_tracking/`](source/d3_skill_discovery/d3_skill_discovery/tasks/downstream/goal_tracking/) |
| **🦾 Pedipulation** | Precise foot positioning and object manipulation | [`pedipulation/`](source/d3_skill_discovery/d3_skill_discovery/tasks/downstream/pedipulation/) |
| **🏃 Velocity Tracking** | Velocity tracking and locomotion control | [`velocity_tracking/`](source/d3_skill_discovery/d3_skill_discovery/tasks/downstream/velocity_tracking/) |
...
|-----------|-------------|----------------|
| **DIAYN** | Diversity is All You Need | [`diayn.py`](source/d3_rsl_rl/d3_rsl_rl/intrinsic_motivation/diayn.py) |
| **METRA** | Meta-Reinforcement Learning with Task Abstraction | [`metra.py`](source/d3_rsl_rl/d3_rsl_rl/intrinsic_motivation/metra.py) |

**Base RL Algorithm:**

- **PPO**: Proximal Policy Optimization - [`ppo.py`](source/d3_rsl_rl/d3_rsl_rl/algorithms/ppo.py)

**Neural Network Modules:**

- **Actor-Critic**: Standard policy network - [`actor_critic.py`](source/d3_rsl_rl/d3_rsl_rl/modules/actor_critic.py)
- **Recurrent AC**: LSTM-based policy - [`actor_critic_recurrent.py`](source/d3_rsl_rl/d3_rsl_rl/modules/actor_critic_recurrent.py)
- More architectures available in [`d3_rsl_rl/d3_rsl_rl/modules/`](source/d3_rsl_rl/d3_rsl_rl/modules/)

### 🔀 Factorized USD

The [`FACTOR_USD`](source/d3_rsl_rl/d3_rsl_rl/intrinsic_motivation/factoized_unsupervised_skill_discovery.py) class manages multiple USD algorithms simultaneously, enabling factorized skill discovery across different observation spaces.
...
Subclass [`BaseSkillDiscovery`](source/d3_rsl_rl/d3_rsl_rl/intrinsic_motivation/base_skill_discovery.py) in `d3_rsl_rl/intrinsic_motivation/`:
...
Add a config class to [`source/d3_skill_discovery/d3_skill_discovery/d3_rsl_rl/rl_cfg.py`](source/d3_skill_discovery/d3_skill_discovery/d3_rsl_rl/rl_cfg.py):
...
Extend the factory class in [`d3_rsl_rl/intrinsic_motivation/factoized_unsupervised_skill_discovery.py`](source/d3_rsl_rl/d3_rsl_rl/intrinsic_motivation/factoized_unsupervised_skill_discovery.py) to initialize your algorithm.
...
- [`source/d3_skill_discovery/d3_skill_discovery/tasks/unsupervised_skill_discovery/anymal_usd/`](source/d3_skill_discovery/d3_skill_discovery/tasks/unsupervised_skill_discovery/anymal_usd/)

**Agent Configs:**

- USD Algorithm: [`rsl_rl_usd_cfg.py`](source/d3_skill_discovery/d3_skill_discovery/tasks/unsupervised_skill_discovery/anymal_usd/config/anymal_d/agents/rsl_rl_usd_cfg.py)
- PPO Hyperparameters: [`rsl_rl_ppo_cfg.py`](source/d3_skill_discovery/d3_skill_discovery/tasks/unsupervised_skill_discovery/anymal_usd/config/anymal_d/agents/rsl_rl_ppo_cfg.py)
