...
import d3_skill_discovery.tasks.downstream.velocity_tracking.mdp as mdp
import d3_skill_discovery.tasks.unsupervised_skill_discovery.anymal_usd.mdp as usd_mdp

##
# Pre-defined configs
##
from d3_skill_discovery.tasks.downstream.velocity_tracking.velocity_tracking_base_env_cfg import VelocityTrackingEnvCfg
...
class ActionsCfg:
    ...
    skill_action = mdp.SkillSelectionActionCfg(
        ...
        skill_policy_file_path="/home/rafael/Projects/MT/CRL/d3_skill_discovery/logs/d3_rsl_rl/metra_factors_ppo_anymal_test/policies_eval/skill_policies/skill_policy_md_4.pt",
        skill_space={
            "position": ("metra_norm_matching", 2),
            "heading": ("dirichlet", 2),
            "weights": ("unit_sphere_positive", 3),
        },
        observation_group="ll_skill_policy",  # ll_skill_policy, ll_oracle_policy
...
@configclass
class VelocityTrackingHLEnvCfg(VelocityTrackingEnvCfg):
    """Configuration for the downstream velocity-tracking environment."""
